...
var = "pTmu"
dataName = var + "_data"
sigName = "selected_sigReco_IntType"
tagList = ["QE", "RES", "DIS", "2p2h", "Other"]
...
for key in mcFile.GetListOfKeys():
  ...
  if name.find(sigName) > -1 and name.find(var) > -1:
    tagID = 0
...
dataHist.AddMissingErrorBandsAndFillWithCV(mcTot)
